...
function pidLoop() {
  ...
  if (activeDisturbance === 'drought') {
    ...
    // Base climate driven dynamically by satellite telemetry
  ...
  // Moisture Delta calculation (inflow minus soil percolation and solar ET0)
  ...
  state.zones.forEach(z => {
    if (z.id === state.activeZoneId) {
      ...
      // Natural passive decay for idle zones scaled with ET0
...
/**
 * Ingest Real-time Satellite Weather Data
 */
function setLiveWeather(w) {
  ...
  // Satellite natural precipitation replenishment
  if (w.rain > 0) {
